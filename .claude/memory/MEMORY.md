...
## Log
- [Course Redesign — static data, schema reset, history page](log/2026-07-course-redesign.md) — 6 คอร์สใหม่, ลบ courses table, courseSlug-based FK, /my-courses/[slug] history, sessionDurationMin=120, **commit `718f471`**
